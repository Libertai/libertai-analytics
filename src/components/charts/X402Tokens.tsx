...
import { useX402TokensQuery } from "@/hooks/useX402TokensQuery";
import { formatCount } from "@/utils/format";

export function X402TokensAnalytics() {
	...
	return (
		<Card>
			<CardHeader>
				<CardTitle>x402 Tokens</CardTitle>
				<CardDescription>Tokens consumption by x402</CardDescription>
			</CardHeader>
