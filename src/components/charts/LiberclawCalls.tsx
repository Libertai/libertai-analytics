...
export function LiberclawAnalytics() {
	...
	const { data: apiData, isLoading, isFetching } = useLiberclawCallsQuery(selectedDates);
	...
	return (
		<Card>
			<CardHeader>
				<CardTitle>Liberclaw API</CardTitle>
				<CardDescription>Number of Liberclaw API calls</CardDescription>
			</CardHeader>
				...
				<div className="relative">
					...
					{!apiData && isLoading ? (
						...
						<MultiModelChartContainer
							data={data}
							cards={[{ number: apiData?.total_calls || 0, description: "Liberclaw API calls", formatter: formatCount }]}
