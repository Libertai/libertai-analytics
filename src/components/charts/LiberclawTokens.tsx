...
import { useLiberclawTokensQuery } from "@/hooks/useLiberclawTokensQuery";
import { formatCount } from "@/utils/format";

export function LiberclawTokensAnalytics() {
	...
	const { data: tokensData, isLoading, isFetching } = useLiberclawTokensQuery(selectedDates);
	...
	return (
		<Card>
			<CardHeader>
				<CardTitle>Liberclaw Tokens</CardTitle>
				<CardDescription>Tokens consumption by Liberclaw users</CardDescription>
			</CardHeader>
